...
public class AirMirrorLoadControl implements LoadControl {
    ...
    public static final class Builder {
         ...
         */
        public AirMirrorLoadControl.Builder setAllocator(DefaultAllocator allocator) {
         ...
         * @throws IllegalStateException If {@link #createDefaultLoadControl()} has already been called.
         */
        public AirMirrorLoadControl.Builder setBufferDurationsMs(
                int minBufferMs,
                int maxBufferMs,
         ...
         * @throws IllegalStateException If {@link #createDefaultLoadControl()} has already been called.
         */
        public AirMirrorLoadControl.Builder setTargetBufferBytes(int targetBufferBytes) {
            Assertions.checkState(!createDefaultLoadControlCalled);
         ...
         * @throws IllegalStateException If {@link #createDefaultLoadControl()} has already been called.
         */
        public AirMirrorLoadControl.Builder setPrioritizeTimeOverSizeThresholds(boolean prioritizeTimeOverSizeThresholds) {
            Assertions.checkState(!createDefaultLoadControlCalled);
         ...
         * @throws IllegalStateException If {@link #createDefaultLoadControl()} has already been called.
         */
        public AirMirrorLoadControl.Builder setBackBuffer(int backBufferDurationMs, boolean retainBackBufferFromKeyframe) {
            Assertions.checkState(!createDefaultLoadControlCalled);
        ...
        public AirMirrorLoadControl createDefaultLoadControl() {
            Assertions.checkState(!createDefaultLoadControlCalled);
            createDefaultLoadControlCalled = true;
            if (allocator == null) {
                allocator = new DefaultAllocator(/* trimOnReset= */ true, C.DEFAULT_BUFFER_SEGMENT_SIZE);
            }
            //Log.v("AirMirrorLoadControl", "bufferForPlaybackAfterRebufferUs:"+bufferForPlaybackAfterRebufferMs+"bufferForPlaybackUs:"+bufferForPlaybackMs);

            return new AirMirrorLoadControl(
                    allocator,
                    minBufferAudioMs,
                    minBufferVideoMs,
                    maxBufferMs,
    ...
    public AirMirrorLoadControl() {
        this(new DefaultAllocator(true, C.DEFAULT_BUFFER_SEGMENT_SIZE));
    }

    /** @deprecated Use {@link DefaultLoadControl.Builder} instead. */
    @Deprecated
    public AirMirrorLoadControl(DefaultAllocator allocator) {
        this(
                allocator,
                /* minBufferAudioMs= */ DEFAULT_MIN_BUFFER_MS,
                /* minBufferVideoMs= */ DEFAULT_MAX_BUFFER_MS,
    ...
    protected AirMirrorLoadControl(
            DefaultAllocator allocator,
    ...
    public boolean shouldStartPlayback(
        ...
        //Log.v("AirMirrorLoadControl", "rebuffering:" +rebuffering+"bufferForPlaybackAfterRebufferUs:"+bufferForPlaybackAfterRebufferUs+"bufferForPlaybackUs:"+bufferForPlaybackUs);

        //Log.v("AirMirrorLoadControl", "AirMirrorLoadControl:" +bufferedDurationUs+"minBufferDurationUs:"+minBufferDurationUs);
